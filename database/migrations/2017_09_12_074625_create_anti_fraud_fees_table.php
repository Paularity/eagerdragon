...
class CreateAntiFraudFeesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('anti_fraud_fees', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->decimal('rebill_transaction', 15, 2)->nullable();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('anti_fraud_fees');
    }
}
