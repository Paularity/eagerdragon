...
class CreateMiscellaneousFeesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('miscellaneous_fees', function (Blueprint $table) {
            ...
            $table->decimal('monthly_1', 15, 2)->nullable();
            $table->decimal('monthly_2', 15, 2)->nullable();
            $table->decimal('transaction_1', 15, 2)->nullable();
            $table->decimal('transaction_2', 15, 2)->nullable();
            $table->timestamps();
