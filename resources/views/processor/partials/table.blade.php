<div class="col-md-12">
    <div class="card">
        <div class="card-block">
                    ...
                    <tbody>
                        @foreach ($processors as $processor)
                            <tr>
                                ...
                                <td class="center">
                                    <a href="{{
                                        url(sprintf('processors/%s', $processor->id)) }}"
                                        class="btn btn-success-outline btn-sm"
                                        title="View"
                                        >
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    <a href="{{ url(sprintf('processors/%s/edit', $processor->id))}}"
                                        class="btn btn-warning-outline btn-sm"
                                        title="Edit"
                                        >
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="{{ url(sprintf('processors/%s', $processor->id))}}"
            ...
            {{ $processors->appends(request()->except('page'))->links() }}
        </div>
    </div>
</div>