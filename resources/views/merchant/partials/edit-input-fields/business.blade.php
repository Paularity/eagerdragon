                    ...
                    @foreach ($businessType as $key => $type)
                        <option value="{{$key}}"
                            @if (
                                ...
                                $businessInfo->business_type == $key
                                )
                                    selected
                                @endif
                            >
        ...
        <div class="col-md-12">
            ...
            <label class="control-label">
                ...
                <textarea  required
                    ...
                    @elseif ($businessInfo->description)
                        >{{ $businessInfo->description }}</textarea>
                    @else
                        ></textarea>
                    @endif
            ...
            <div class="form-group
                ...
                <select required class="form-control underlined form-control-sm"
                    ...
                    @foreach ($countryList as $key => $value)
                        <option
                            @if ($businessInfo && $businessInfo->business_country === $key)
                                selected
                            @elseif($key === old('business_country'))
                                selected
                            @endif
                            value="{{ $key }}">
                            {{ $value }}
